export const sanPopulation: SanPopulation = [
    ...
    },
    {
        ...
        steps: [
            { item: 'offenceDescription', value: `Offence description for assessment 1` },
...
export const modifySanForAssessment2: SanPopulation = [

    {
        section: 'Offence analysis',
        steps: [
            { item: 'change' },
            { item: 'offenceDescription', value: `Offence description modified for offender 2` },
            { item: 'saveAndContinue' },
            { item: 'saveAndContinue' },
            { item: 'markAsComplete' },
        ],
...
export const modifySanForAssessment3: SanPopulation = [

    {
        section: 'Offence analysis',
        steps: [
            { item: 'change' },
            { item: 'offenceDescription', value: `Offence description modified for 3rd assessment on merged offender` },
            { item: 'motivations', value: 'financial' },
            { item: 'saveAndContinue' },
            { item: 'saveAndContinue' },
            { item: 'markAsComplete' },
        ],
