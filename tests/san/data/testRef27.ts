export const test2SanAlcohol: SanPopulation = [
    {
        section: 'Alcohol use',
        steps: [
...
export const test2SpCreateGoal: SanPopulation = [
    {
...
export const part3CompleteSan: SanPopulation = [
    {
...
export const test4ModifyAlcohol: SanPopulation = [
    {
        section: 'Alcohol use',
        steps: [
            { item: 'change' },
