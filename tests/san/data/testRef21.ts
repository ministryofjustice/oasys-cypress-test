export const assessment3: SanPopulation = [
    {
        section: 'Accommodation',
        steps: [
            { item: 'currentAccommodation', value: 'settled' },
            { item: 'settledAccommodationType', value: 'homeowner' },
...
export const assessment5: SanPopulation = [
    {
        section: 'Accommodation',
        steps: [
            { item: 'change' },
...
export const assessment6: SanPopulation = [
    {
        section: 'Accommodation',
        steps: [
            { item: 'change' },
...
export const assessment7: SanPopulation = [
    {
        section: 'Accommodation',
        steps: [
            { item: 'change' },
            { item: 'settledAccommodationType', value: 'socialRent' },
            { item: 'saveAndContinue' },
            { item: 'saveAndContinue' },
            { item: 'practitionerAnalysis' },
            { item: 'markAsComplete' }
