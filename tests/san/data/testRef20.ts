export const sanPopulation: SanPopulation = [
    ...
    },
    {
        ...
        steps: [
            ...
            { item: 'saveAndContinue' },
            { item: 'drugType', value: `heroin` },
            { item: 'heroinLastSixMonths', value: 'yes' },
            { item: 'saveAndContinue' },
            { item: 'heroinFrequency', value: 'weekly' },
            { item: 'injected', value: 'heroin' },
            { item: 'heroinInjectedLastSixMonths', value: 'lastSix' },
            { item: 'treatment', value: 'no' },
            { item: 'saveAndContinue' },
            { item: 'whyStarted', value: `cultural` },
            { item: 'impactDrugs', value: `behavioural` },
            { item: 'wantChangesDrugs', value: 'notAnswering' },
            { item: 'saveAndContinue' },
            { item: 'practitionerAnalysis' },
