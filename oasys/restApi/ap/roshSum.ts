...
export class APRoshSumAssessment extends apCommon.APAssessmentCommon {
    ...
    addRoshSumDetails(assessment: dbClasses.DbAssessment) {
        ...
        this.riskIncreaseLikelyTo = common.getTextAnswer(assessment.textData, 'ROSHSUM', 'SUM4')
        this.riskReductionLikelyTo = common.getTextAnswer(assessment.textData, 'ROSHSUM', 'SUM5')
    }
}
