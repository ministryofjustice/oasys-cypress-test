...
export class DbRiskDetails {
    ...
    constructor(riskData: string[], standaloneRsr: boolean = false) {
        ...
        if (standaloneRsr) {
            this.ogrs31Year = Number.parseInt(riskData[5])
            this.ogrs32Year = Number.parseInt(riskData[6])
            this.ogrs3RiskRecon = riskData[7]

            this.rsrStaticOrDynamic = riskData[8]
            this.rsrExceptionError = riskData[9]
            this.rsrAlgorithmVersion = Number.parseInt(riskData[10])
            this.rsrPercentageScore = Number.parseFloat(riskData[11])
            this.scoreLevel = riskData[12]
            this.ospImagePercentageScore = Number.parseFloat(riskData[13])
            this.ospContactPercentageScore = Number.parseFloat(riskData[14])
            ...
            this.ospIndirectImagesChildrenPercentageScore = Number.parseFloat(riskData[19])
            this.ospDirectContactScoreLevel = riskData[20]
            this.ospDirectContactPercentageScore = Number.parseFloat(riskData[21])

        } else {
            this.ogpStWesc = Number.parseInt(riskData[7])
            this.ogpDyWesc = Number.parseInt(riskData[8])
            this.ogpTotWesc = Number.parseInt(riskData[9]) || null
            this.ogp1Year = Number.parseInt(riskData[10])
            this.ogp2Year = Number.parseInt(riskData[11])
            this.ogpRisk = riskData[12]

            this.ovpStWesc = Number.parseInt(riskData[13])
            this.ovpDyWesc = Number.parseInt(riskData[14])
            this.ovpTotWesc = Number.parseInt(riskData[15]) || null
            this.ovp1Year = Number.parseInt(riskData[16])
            this.ovp2Year = Number.parseInt(riskData[17])
            this.ovpRisk = riskData[18]
            this.ovpPrevWesc = Number.parseInt(riskData[19])
            this.ovpNonVioWesc = Number.parseInt(riskData[20])
            this.ovpAgeWesc = Number.parseInt(riskData[21])
            this.ovpVioWesc = Number.parseInt(riskData[22])
            this.ovpSexWesc = Number.parseInt(riskData[23])

            this.ogrs31Year = Number.parseInt(riskData[24])
            this.ogrs32Year = Number.parseInt(riskData[25])
            this.ogrs3RiskRecon = riskData[26]

            this.rsrStaticOrDynamic = riskData[27]
            this.rsrExceptionError = riskData[28]
            this.rsrAlgorithmVersion = Number.parseInt(riskData[29])
            this.rsrPercentageScore = Number.parseFloat(riskData[30])
            this.scoreLevel = riskData[31]

            this.ospImagePercentageScore = Number.parseFloat(riskData[32])
            this.ospContactPercentageScore = Number.parseFloat(riskData[33])
            ...
            this.ospIndirectImagesChildrenPercentageScore = Number.parseFloat(riskData[44])
            this.ospDirectContactScoreLevel = riskData[45]
            this.ospDirectContactPercentageScore = Number.parseFloat(riskData[46])
        }
...
export class DbSection {
    ...
    constructor(sectionData: string[]) {
        ...
        this.otherWeightedScore = Number.parseInt(sectionData[2])
        this.lowScoreNeedsAttn = sectionData[3]
        this.crimNeedScoreThreshold = Number.parseInt(sectionData[4])
    }
