...
export class Section6 extends BaseAssessmentPage {
    ...
    o6_7VictimPartner = new Element.Select<YesNoAnswer>('#itm_6_7_1_1da')
    o6_7VictimFamily = new Element.Select<YesNoAnswer>('#itm_6_7_1_2da')
    o6_7PerpetratorPartner = new Element.Select<YesNoAnswer>('#itm_6_7_2_1da')
    o6_7PerpetratorFamily = new Element.Select<YesNoAnswer>('#itm_6_7_2_2da')
    o6_9 = new Element.Select<YesNoAnswer>('#itm_6_9')
    o6_10 = new Element.Select<'No problems' | 'Some problems' | 'Significant problems'>('#itm_6_10')
    o6_11 = new Element.Select<YesNoAnswer>('#itm_6_11')
    o6_12 = new Element.Select<ProblemsAnswer>('#itm_6_12')
    identifyIssues = new Element.Textbox('#textarea_6_97')
    linkedToRisk = new Element.Select<YesNoAnswer>('#itm_6_98')
    linkedToBehaviour = new Element.Select<YesNoAnswer>('#itm_6_99')
}
