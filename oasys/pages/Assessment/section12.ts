...
export class Section12 extends BaseAssessmentPage {
    ...
    o12_1 = new Element.Select<ProblemsAnswer>('#itm_12_1')
    o12_3 = new Element.Select<ProblemsAnswer>('#itm_12_3')
    o12_4 = new Element.Select<ProblemsAnswer>('#itm_12_4')
    o12_5 = new Element.Select<ProblemsAnswer>('#itm_12_5')
    o12_6 = new Element.Select<ProblemsAnswer>('#itm_12_6')
    o12_8 = new Element.Select<''|'0-Very motivated'|'1-Quite motivated'|'2-Not at all'>('#itm_12_8')
    o12_9 = new Element.Select<ProblemsAnswer>('#itm_12_9')
