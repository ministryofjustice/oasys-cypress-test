...
export class OffenderInformation extends BaseAssessmentPage {
    ...
    dischargeAddressLine1 = new Element.Textbox('#P2_DISCHARGE_ADDRESS_LINE_1')
    dischargeAddressLine2 = new Element.Textbox('#P2_DISCHARGE_ADDRESS_LINE_2')
    dischargeAddressLine3 = new Element.Textbox('#P2_DISCHARGE_ADDRESS_LINE_3')
    dischargeAddressLine4 = new Element.Textbox('#P2_DISCHARGE_ADDRESS_LINE_4')
    dischargeAddressLine5 = new Element.Textbox('#P2_DISCHARGE_ADDRESS_LINE_5')
    dischargeAddressLine6 = new Element.Textbox('#P2_DISCHARGE_ADDRESS_LINE_6')
    dischargePostcode = new Element.Textbox('#P2_DISCHARGE_POST_CODE')
    dischargeTelephone = new Element.Textbox('#P2_DISCHARGE_TELEPHONE_NUM')
