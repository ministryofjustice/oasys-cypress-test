...
export class Section9 extends BaseAssessmentPage {
    ...
    o9_1 = new Element.Select<ProblemsMissingAnswer>('#itm_9_1')
    o9_1Details = new Element.Textbox('#textarea_9_1_t')
    o9_2 = new Element.Select<ProblemsMissingAnswer>('#itm_9_2')
    o9_3 = new Element.Select<ProblemsMissingAnswer>('#itm_9_3')
    o9_4 = new Element.Select<YesNoMissingAnswer>('#itm_9_4')
    o9_5 = new Element.Select<ProblemsMissingAnswer>('#itm_9_5')
