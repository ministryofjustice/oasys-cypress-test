...
export class ChildAtRisk extends Page {
    ...
    currentNeglect = new Element.Checkbox('#itm2353C')
    currentPhysical = new Element.Checkbox('#itm2354C')
    currentSexual = new Element.Checkbox('#itm2355C')
    currentEmotional = new Element.Checkbox('#itm2356C')
    previousNeglect = new Element.Checkbox('#itm2353P')
    previousPhysical = new Element.Checkbox('#itm2354P')
    previousSexual = new Element.Checkbox('#itm2355P')
    previousEmotional = new Element.Checkbox('#itm2356P')
