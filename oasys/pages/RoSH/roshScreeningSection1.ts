...
export class RoshScreeningSection1 extends BaseAssessmentPage {
    ...
    r1_2_1P = new Element.Select('#itm_R1_2_1_2_V2')        // Murder / attempted murder / threat or conspiracy to murder / manslaughter
    r1_2_2P = new Element.Select('#itm_R1_2_2_2_V2')        // Wounding / GBH(Sections 18 / 20 Offences Against the Person Act 1861)
    r1_2_3P = new Element.Select('#itm_R1_2_3_2_V2')        // Any sexual offence against a child(ren)
    r1_2_4P = new Element.Select('#itm_R1_2_4_2_V2')        // Rape or serious sexual offence against an adult
    r1_2_5P = new Element.Select('#itm_R1_2_5_2_V2')        // Any other offence against a child(see revised Appendix 1)
    r1_2_6P = new Element.Select('#itm_R1_2_6_2_V2')        // Aggravated burglary
    r1_2_7P = new Element.Select('#itm_R1_2_7_2_V2')        // Arson
    r1_2_8P = new Element.Select('#itm_R1_2_8_2_V2')        // Criminal damage with the intent to endanger life
    r1_2_9P = new Element.Select('#itm_R1_2_9_2_V2')        // Kidnapping / false imprisonment
    r1_2_10P = new Element.Select('#itm_R1_2_10_2_V2')      // Possession of a firearm with intent to endanger life or resist arrest
    r1_2_11P = new Element.Select('#itm_R1_2_11_2_V2')      // Racially motivated / racially aggravated offence
    r1_2_12P = new Element.Select('#itm_R1_2_12_2_V2')      // Robbery
    r1_2_13P = new Element.Select('#itm_R1_2_13_2_V2')      // Any offence involving possession and / or use of weapons
    r1_2_14P = new Element.Select('#itm_R1_2_14_2_V2')      // Any other offence which is as serious, eg blackmail, harassment, stalking, indecent images of children, child neglect, abduction etc.
    otherOffence = new Element.Textbox('#textarea_R1_2_14_t_V2')    // Indicate offence    
    r1_2_16P = new Element.Select('#itm_R1_2_16_2_V2')      // Any offence commited in a custodial setting
