...
const nameCorrections = {
    ...
    OVP2_PERCENTAGE: 'OVP2_PERCENTAGE2',
    OGRS4V_TOT_VIOLENT_SANC: 'OGRS4V_TOT_VIOLENT_SANCTIONS',
    OVP2_TOT_VIOLENT_SANC: 'OVP2_TOTAL_VIOLENT_SANCTIONS',
    OSP_DC_MISSING_QUESTIONS: 'OSP_DC_MISSED_QUESTIONS',
    OSP_IIC_MISSING_QUESTIONS: 'OSP_IIC_MISSED_QUESTIONS',
}
